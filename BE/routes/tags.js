...
const { create } = require('../controllers/tags/create')
const { get } = require('../controllers/tags/get')
const { getAll } = require('../controllers/tags/getAll')
const { update } = require('../controllers/tags/update')
const { _delete } = require('../controllers/tags/delete')
